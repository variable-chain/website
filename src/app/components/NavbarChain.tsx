...
const NavbarChain: React.FC<NavbarChainProps> = ({ onToggle }) => {
      ...
      >
        <div className={` ${styles.navbar} flex justify-between items-center `}>
          ...
          <div className="hidden md:flex space-x-10 border border-solid bg-[#131313] border-gray-600 border-light rounded-full xl:p-4 xl:px-10 lg:p-3 lg:px-2 md:p-2 md:px-2">
            ...
            <Link href="https://explorer.variable.foundation" className="text-[#666666] hover:none">
              Explorer
            </Link>
            <Link href="/governance" className="text-[#666666] hover:none">
              Governance
            </Link>
            <a href="https://bridge.variable.foundation" className="text-[#666666] hover:none">
              Bridge
            </a>
        ...
        {menuOpen && (
          <div className={`md:hidden mt-4 ${styles.navbar_phone}`}>
            ...
            <a href="https://bridge.variable.foundation" className="block text-white py-2">
              Explorer
            </a>
            <a href="https://explorer.variable.foundation" className="block text-white py-2">
              Explorer
            </a>
            <a href="#" className="block text-white py-2">
              Governance
